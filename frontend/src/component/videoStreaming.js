...
const Video = memo((props) => {
  ...
  return <video className="video-grid" playsInline autoPlay ref={ref}></video>;
});
...
const VideoStreaming = (props) => {
  ...
  return (
    <div>
        ...
        {joinChat &&
          allUsers.map((user) => (
            ...
            >
              ...
              <button
                className="report"
                onClick={() => handleReportMenu(user.username)}
                style={{ height: "20px", alignSelf: "center" }}
                disabled={disabledButtons.includes(user.username)}
              >
                Report
              </button>
            </div>
      ...
      <div
        className="videos"
        style={peers.length > 0 ? { display: "grid" } : { display: "grid" }}
      >
        <div>
          <video
      ...
      {showReportPopup && (
        <div className="popup">
          <p>
            You &#40;{username}&#41; are reporting {selectedUser} for
          </p>
          <div>
            <label>
              <input
                ...
                checked={selectedReason === "sexualContent"}
                disabled={
                  selectedReason !== "" && selectedReason !== "sexualContent"
                }
              />
              Sexual content
            </label>
            ...
            <label>
              <input
                ...
                onChange={handleCheckboxChange}
                checked={selectedReason === "violentContent"}
                disabled={
                  selectedReason !== "" && selectedReason !== "violentContent"
                }
              />
            ...
            <label>
              <input
                type="checkbox"
                name="reportReason"
                value="hatefulContent"
                onChange={handleCheckboxChange}
                checked={selectedReason === "hatefulContent"}
                disabled={
                  selectedReason !== "" && selectedReason !== "hatefulContent"
                }
              />
            ...
            <label>
              <input
                ...
                onChange={handleCheckboxChange}
                checked={selectedReason === "harmfulContent"}
                disabled={
                  selectedReason !== "" && selectedReason !== "harmfulContent"
                }
              />
