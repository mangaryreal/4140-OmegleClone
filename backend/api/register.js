...
router.post("/register", async (request, response) => {
  ...
  try {
    ...
    do {
      ...
      const checkUsernameResult = await client.query(checkUserIDQuery, [
        userID,
      ]);
    ...
    response
      ...
      .send({
        message:
          "Successful registration, Your User ID is " +
          userID +
          ". Please remember your User ID, it is the only way to log in.",
      });
